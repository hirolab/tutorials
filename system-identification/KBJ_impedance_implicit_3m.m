classdef KBJ_impedance_implicit_3m < handle
    ...
    methods
        ...
        function [obj, u, y, x0, P0, x] = KBJ_impedance_implicit_3m(stiff, damp, mass, mass2, Fs, mocapCov, forceCov, ...
                                                                    xp, xf, xs, f, resCov)
        ...
        function h = Measurement(obj, x, v, uy)
            ...
            res = KBJ_impedance_implicit_3m.residual_fcn(...
        ...
        function [dhdx, dhdv] = MeasurementJacobian(obj, x, v, uy)
            ...
            params = [obj.stiff, obj.damp, obj.mass, obj.mass2];
            [~, ~, res_z, res_f] = KBJ_impedance_implicit_3m.residual_fcn(...
                params, xp(1), xp(2), xp(3), xf(1), xf(2), xf(3), xs(1), xs(2), f);
             
            dhdx = res_z * obj.Deriv_blk;
        ...
        function [Sinv, Q, func] = wrap_cost_fcn(obj, X, P, U, Y)
            ...
            func = @(params, Q) KBJ_impedance_implicit_3m.residual_fcn(params, ...
